...
interface iCards {
    ...
    onerror: (this: iCards, ev: ErrorEvent) => any;
    myElement: HTMLImageElement;
}
const Cards: React.FC<iCards> = ({dataBerita,myElement}) => {
                                ...
                                <div className="h-full text-left px-4 py-4 bg-gray-800 w-full justify-end border-t-2 border-gray-900">
                                    <a className="flex items-center flex-wrap">
                                        <img
                                            ...
                                            src={item.picture} onError={()=>{onerror = null; myElement.src="https://dummyimage.com/302x302/94a3b8/ffffff"}}/>
