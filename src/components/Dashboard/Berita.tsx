            ...
            <CardBody>
                ...
                <div className="overflow-y-auto" style={{maxHeight:'600px'}}>
                {
                    dataBerita?.length>0?dataBerita.map((item:iContent,i:number)=>{
                        return (
                            <div key={i} className="bg-gray-800 w-128 rounded shadow-md flex card text-grey-darkest">
                                <img className="w-12 h-12 mb-4 mr-2 bg-gray-100 rounded" src={item.picture} alt="Room Image"  />
                                ...
                                <div className="w-full flex flex-col cursor-pointer">
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div dangerouslySetInnerHTML={{__html: item.caption.length>40?item.caption.substr(0,40)+'..':item.caption}}></div>
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                            ...
                            //     <div className="h-full text-left px-4 py-4 bg-gray-800 w-full justify-start border-t-2 border-gray-900">
                            ...
                            //                 {((item.caption.replace(/<[^>]*>?/gm, '')).replace(/&nbsp;/g, '')).substr(0,30)}
                            //                 </span>
                            //             </span>
                            //         </a>
                            //     </div>
